...
MAX_CONGRATS_LENGTH = 400  # Максимальная длина поздравительного сообщения
...
Примечание: Максимальная длина текста — 850 символов (без тегов). Максимум 100 кастомных эмодзи в сообщении.</blockquote>
"""
